  ...
  return (
    <div>
      <p className="text-2xl py-10 text-center md:text-3xl lg:text-4xl underline font-bold text-[#4d6429] group-hover:text-white">
        ...
        <div className="md:w-[90%] px-5 mx-auto justify-evenly gap-5 md:gap-8 lg:gap-10  flex flex-col lg:flex-row  ">
          <div className="md:w-[90%] flex mx-auto flex-1 h-[300px] sm:h-[350px] md:h-[400px] lg:h-[550px]">

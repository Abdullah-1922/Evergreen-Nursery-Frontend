  ...
  return (
    <section>
      <div className="px-10 py-20">
        <p className="py-5 font-serif text-4xl ">FAQ </p>
        <div className="relative mb-3">
            ...
            >
              ...
              <i
                className={`absolute right-0 pt-1 text-xs ${
                  isOpen1 ? "fas fa-minus" : "fas fa-plus"
                }`}
              ></i>
            </button>
          </h6>
          ...
          >
            <div className="p-4 text-sm leading-normal text-blue-gray-500/80">
              Indoor plants require proper watering, adequate light, and
              occasional fertilization to thrive indoors.
            </div>
          </div>
        </div>
        ...
        <div className="relative mb-3">
          <h6 className="mb-0">
            ...
            >
              ...
              <i
                className={`absolute right-0 pt-1 text-xs ${
                  isOpen2 ? "fas fa-minus" : "fas fa-plus"
                }`}
              ></i>
            </button>
          </h6>
          ...
          >
            <div className="p-4 text-sm leading-normal text-blue-gray-500/80">
              Plants like snake plants and pothos thrive in low light conditions
              and are perfect for indoor settings.
            </div>
          </div>
        </div>
        ...
        <div className="relative mb-3">
          <h6 className="mb-0">
            ...
            >
              ...
              <i
                className={`absolute right-0 pt-1 text-xs ${
                  isOpen3 ? "fas fa-minus" : "fas fa-plus"
                }`}
              ></i>
            </button>
          </h6>
          ...
          >
            <div className="p-4 text-sm leading-normal text-blue-gray-500/80">
              Indoor plants improve air quality, reduce stress levels, and add a
              touch of nature to your living space.
            </div>
          </div>
        </div>
      </div>
